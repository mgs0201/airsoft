...
--> 	<div class="py-5 bg-info" style="background-image: url(imagenes/portada.jpeg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;  height: 400px;">
